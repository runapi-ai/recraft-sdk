...
import type { BackgroundRemovalParams, CompletedImageTaskResponse, ImageTaskResponse, TaskCreateResponse } from '../types';

const ENDPOINT = '/api/v1/recraft/background_removals';

export class BackgroundRemovals {
  constructor(private readonly http: HttpClient) {}

  async run(params: BackgroundRemovalParams, options?: RequestOptions & PollingOptions): Promise<CompletedImageTaskResponse> {
  ...
  async create(params: BackgroundRemovalParams, options?: RequestOptions): Promise<TaskCreateResponse> {
